...
const Hero: React.FC = () => {
  ...
  const thumbnailItems = [
    "/thumbnails/Thumbnail-10.jpg",
    "/thumbnails/Thumbnail-11.jpg",
    "/thumbnails/Thumbnail-12.jpg",
  ...
  return (
    ...
    >
      ...
      >
        <h1
          ref={textRef}
          className={`font-sans text-[clamp(4.5rem,17vw,24rem)] font-black tracking-tighter text-foreground drop-shadow-2xl leading-none uppercase`}
        >
          {text}
        </h1>
        <p
